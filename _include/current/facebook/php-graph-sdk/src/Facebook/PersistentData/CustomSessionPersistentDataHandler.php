 ...
 * @package Facebook
 */
class CustomSessionPersistentDataHandler implements PersistentDataInterface
{
    /**
    ...
    {
        return get_session($this->sessionPrefix . $key, null);
    }
    ...
    {
        set_session($this->sessionPrefix . $key, $value);
    }
}
