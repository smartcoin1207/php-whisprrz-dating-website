	...
	function action()
	{
		...
		}else if($cmd == 'save')
        {
            ...
            if ($_FILES['slider_image']['name'] != ""){
                ...
                //popcorn modified s3 bucket wowslider image upload 2024-05-06
                ...
                //popcorn modified s3 bucket wowslider image upload to s3 bucket 2024-05-06
                if(getFileDirectoryType('wowslider') == 2) {
        ...
        if($cmd == 'del'){
            ...
            $wowslider = DB::row("SELECT * FROM wowslider_main WHERE event_id=" . to_sql($eid) . " LIMIT 1");
            if($wowslider) {
