...
class CForm extends CHtmlBlock
{
	...
	function action()
	{
		...
		redirect("groups_group_comment_comments.php?action=saved&comment_id=".$comment['parent_id']);
		}
	}
	function parseBlock(&$html)
	{
        ...
        if($comment = DB::fetch_row())
        {
		$group_id = DB::field('wall_comments','group_id','id ='.$comment['parent_id']);
                $group_name=DB::field('groups_social','title','group_id ='.$group_id[0]);
