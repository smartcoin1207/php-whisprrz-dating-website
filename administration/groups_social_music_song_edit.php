	...
	function action()
	{
		...
		if ($cmd == "update")
		{
	        ...
	        if($song = DB::fetch_row())
	        {
                ...
                redirect("groups_social_music_song_edit.php?action=saved&song_id=".$song['song_id']);
	        }
		}
	}
	function parseBlock(&$html)
	{
        ...
        if($song = DB::fetch_row())
        {
            ...
            if ($song['song_title']) {
				...
				$html->setvar('song_title_header_short', $song['song_title']);
...
$page = new CForm("", $g['tmpl']['dir_tmpl_administration'] . "groups_social_music_song_edit.html");
