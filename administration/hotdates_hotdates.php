...
class CPlaces extends CHtmlList
{
	...
	function init()
	{
		...
		$this->m_sql_count = "SELECT COUNT(m.hotdate_id) FROM hotdates_hotdate AS m " . $this->m_sql_from_add . "";
		$this->m_sql = "
			SELECT m.*
		...
		$this->m_field['hotdate_datetime'] = array("hotdate_datetime", null);
		$this->m_field['hotdate_has_images'] = array("hotdate_has_images", null);
        $this->m_field['hotdate_n_guests'] = array("hotdate_n_guests", null);
	...
	function onItem(&$html, $row, $i, $last)
	{
		...
		$this->m_field['hotdate_has_images'][1] =  ($row['hotdate_has_images'])? l('yes'):l('no');
...
$page = new CPlaces("main", $g['tmpl']['dir_tmpl_administration'] . "hotdates_hotdates.html");
