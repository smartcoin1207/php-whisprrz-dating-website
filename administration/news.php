...
class CNews extends CHtmlList
{
	...
	function action()
	{
		...
		if ($del != "")
		{
			...
			for ($i = 1; $i <= 5; $i++)
			{
				if (custom_file_exists($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_s.jpg")) unlink($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_s.jpg");
				if (custom_file_exists($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_s.jpg")) unlink($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_m.jpg");
				if (custom_file_exists($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_s.jpg")) unlink($g['path']['dir_files'] . "news/" . $del . "_" . $i . "_b.jpg");
			}
