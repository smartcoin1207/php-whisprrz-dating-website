...
class CEvents extends CHtmlBlock
{
    ...
    function parseBlock(&$html)
    {
       ...
       if($html->varExists('page_title')){
            ...
            if($uid == $guid) {
                $html->setvar('url_page_task_create', 'events_event_edit.php');
        ...
        $html->setvar('upcoming_event_url', 'events_event_list_upcoming.php');
        $html->setvar('upcoming_event_title', l('events_upcoming_events'));
