...
require_once("./_include/current/events/event_search.php");
...
$events_calendar_search = new CEventCalendarSearch("events_calendar_search", $g['tmpl']['dir_tmpl_main'] . "_calendar_search.html");
$page->add($events_calendar_search);
