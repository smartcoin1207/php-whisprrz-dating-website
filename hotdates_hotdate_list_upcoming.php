...
require_once("./_include/current/hotdates/hotdate_search.php");
...
$hotdates_calendar_search = new CHotdateCalendarSearch("hotdates_calendar_search", $g['tmpl']['dir_tmpl_main'] . "_calendar_search.html");
$page->add($hotdates_calendar_search);
