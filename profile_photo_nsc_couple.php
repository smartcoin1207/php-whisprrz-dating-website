...
//only auth user nsc couple profile image 
$guid = guid();
$g_user = User::getInfoBasic($guid);
$nsc_couple_id = $g_user['nsc_couple_id'];
$nsc_user = User::getInfoBasic($nsc_couple_id);

$_GET['name_seo'] = $nsc_user['name_seo'];
$_GET['profile_photo_nsc_couple'] = 1;
...
$tmplList = array(
    'main'   => $dirTmpl . 'profile_photo_nsc_couple.html',
